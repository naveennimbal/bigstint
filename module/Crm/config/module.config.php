...
return array(
    'router' => array(
        'routes' => array(
            ...
            'broadcast' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/crm/broadcast[/][:action][/:id]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ),
                    'defaults' => array(
                        'controller' => 'Crm\Controller\Broadcast',
                        'action' => 'index',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'Crm\Controller\Broadcast' => 'Crm\Controller\BroadcastController'
        ),
    ),
    'view_manager' => array(
        ...
        'template_map' => array(
            'layout/layout'           => __DIR__ . '/../view/layout/crm.phtml',
